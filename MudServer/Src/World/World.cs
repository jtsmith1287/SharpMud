...
namespace MudServer.World {
    public static class World {
        ...
        public static readonly Dictionary<Guid, NonPlayerCharacter> Mobiles = new Dictionary<Guid, NonPlayerCharacter>();
        public static readonly Dictionary<Guid, MudServer.Entity.Item> Items = new Dictionary<Guid, MudServer.Entity.Item>();
        ...
        public static MudServer.Entity.Entity GetEntity(Guid id) {
            if (PlayerCharacter.Players.TryGetValue(id, out PlayerCharacter player)) return player;
            if (Mobiles.TryGetValue(id, out NonPlayerCharacter npc)) return npc;
            if (Items.TryGetValue(id, out Item item)) return item;
            return null;
        }
        ...
        public static bool AddRoom(Room room) {
            ...
            if (Rooms.TryGetValue(stringCoord, out Room _)) {
                return false;
            }
