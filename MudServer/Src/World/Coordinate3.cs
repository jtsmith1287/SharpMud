...
public class Coordinate3 {
    ...
    [ScriptIgnore]
    private static Coordinate3 _zero;

    public static Coordinate3 Zero {
        get {
            if (_zero == null) {
                _zero = new Coordinate3(0, 0, 0);
            }

            return (Coordinate3)_zero.MemberwiseClone();
        }
        private set => _zero = value;
    }

    public static Coordinate3 Purgatory => new Coordinate3(int.MaxValue, int.MaxValue, int.MaxValue);
