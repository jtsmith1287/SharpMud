    ...
    public static void LoadData(params string[] paths) {
        ...
        foreach (string path in paths) {
            try {
                ...
                switch (path) {
                    case DataPaths.IdData:
                        Dictionary<string, Data> rawIdData = serializer.Deserialize<Dictionary<string, Data>>(json) ??
                        ...
                        break;
                    case DataPaths.UserId:
                        Dictionary<string, string> rawUserId
                    ...
                    case DataPaths.World:
                        ...
                        if (File.Exists(DataPaths.MapList)) {
                            ...
                            Dictionary<string, List<string>> mapList
                                = serializer.Deserialize<Dictionary<string, List<string>>>(mapListJson);
                            ...
                            World.Rooms = serializer.Deserialize<Dictionary<string, Room>>(json) ??
